...
public class CubeSnapUpsGenerator {
    ...
    public State getSnapUpResultState(State currentState, Action action) {
        ...
        Element[][] upSideColors = ((ClassicSide) upSide).getColors();
        Element[][] downSideColors = ((ClassicSide) downSide).getColors();
        Element[][] frontSideColors = ((ClassicSide) frontSide).getColors();
        Element[][] rightSideColors = ((ClassicSide) rightSide).getColors();
        Element[][] backSideColors = ((ClassicSide) backSide).getColors();
        Element[][] leftSideColors = ((ClassicSide) leftSide).getColors();
        ...
        switch ((SnapUp) action) {
            ...
            case RIGHT_TO_FRONT:
                ...
                break;
            case UP_TO_FRONT:
                newUpSide = new ClassicSide(new Element[][]{
                ...
                newFrontSide = upSide;
                newRightSide = new ClassicSide(new Element[][]{
                    ...
                    {rightSideColors[0][0], rightSideColors[1][0],
                        rightSideColors[2][0]}});
                newBackSide = new ClassicSide(new Element[][]{
                    ...
                    {downSideColors[0][2], downSideColors[0][1],
                        downSideColors[0][0]}});
                newLeftSide = new ClassicSide(new Element[][]{
            ...
            case DOWN_TO_FRONT:
                newUpSide = frontSide;
                newDownSide = new ClassicSide(new Element[][]{
            ...
            case LEFT_TO_UP:
                ...
                newDownSide = new ClassicSide(new Element[][]{
                    ...
                    {rightSideColors[2][2], rightSideColors[1][2],
                        rightSideColors[0][2]}});
                newFrontSide = new ClassicSide(new Element[][]{
